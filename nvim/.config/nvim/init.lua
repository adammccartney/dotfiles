...
vim.opt.backupdir = { state .. '/backup//' } -- keep backups from creating a tangle for git
...
vim.opt.directory = { state .. '/nvim/swap//', '.' } -- keep swap files out of the way, fallback to cwd on failure
