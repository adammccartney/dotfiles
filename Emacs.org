...
Check out https://github.com/org-roam/org-roam-ui for more info,
this is basically an visual tool for exploring the graph generated by org-roam
#+begin_src emacs-lisp :tangle emacs/.emacs.d/init.el
...
* Messaging
** zeromq
#+begin_src elisp :tangle emacs/.emacs.d/init.el
  (use-package zmq)
#+end_src
* readers
** jupyter notebooks
erm ... kind of a reader
